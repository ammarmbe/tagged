    ...
    <>
      <Dialog.Root open={filtersOpen} onOpenChange={setFiltersOpen}>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed inset-y-0 right-0 z-50 flex h-full w-3/4 flex-col bg-white transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm">
            ...
            <div className="grid grid-cols-2 gap-4 gap-y-1 px-6 py-5">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  Array.from(Object.entries(newFilters)).forEach(
                    ([key, value]) => {
                      if (value)
